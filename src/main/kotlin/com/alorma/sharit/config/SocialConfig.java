package com.alorma.sharit.config;


import javax.inject.Inject;
import javax.sql.DataSource;

import com.alorma.sharit.user.SecurityContext;
import com.alorma.sharit.user.SimpleConnectionSignUp;
import com.alorma.sharit.user.SimpleSignInAdapter;
...
public class SocialConfig implements SocialConfigurer {
	...
	public UserIdSource getUserIdSource() {
		return () -> SecurityContext.INSTANCE.getUser().getId();
	}
